# Generated by Django 4.1 on 2023-11-26 19:57
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        default=apps.core.enums.Request["NOT_REQUESTED"],
                        max_length=16,
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        validators=[
                            utils.validators.Validators.validate_future_datetime
                        ]
                    ),
                ),
                (
                ...
                (
                    "payment_method",
                    models.CharField(
                        choices=[("ONLINE", "ONLINE"), ("CASH", "EFECTIVO")],
                        max_length=16,
                    ),
                ),
                ...
                (
                    ...
                    models.CharField(
                        ...
                        default=apps.core.enums.BookingStatus["PENDING"],
                        max_length=16,
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        default=apps.core.enums.ClaimStatus["PENDING"],
                        max_length=16,
                    ),
                ),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="core.accommodation"
            ),
        ),
        migrations.AddField(
            model_name="favorite",
        ...
        migrations.AddIndex(
            model_name="favorite",
            index=models.Index(
                fields=["accommodation"], name="core_favori_accommo_f5f42f_idx"
            ),
        ),
        migrations.AlterUniqueTogether(
            name="favorite",
        ...
        migrations.AddIndex(
            model_name="comment",
            index=models.Index(
                fields=["accommodation"], name="core_commen_accommo_584ecb_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="claim",
        ...
        migrations.AddIndex(
            model_name="claim",
            index=models.Index(
                fields=["accommodation"], name="core_claim_accommo_1ab387_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="claim",
        ...
        migrations.AddIndex(
            model_name="book",
            index=models.Index(
                fields=["accommodation"], name="core_book_accommo_c4dd48_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="book",
        ...
        migrations.AddIndex(
            model_name="accommodation",
            index=models.Index(
                fields=["category"], name="core_accomm_categor_df7e94_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="customuser",
